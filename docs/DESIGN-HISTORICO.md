...
> Contenido movido acá el 2026-09-07 desde `docs/DESIGN.md` para que no se cargue en
> cada sesión de Claude Code (ver `docs/DESIGN.md` para el estado actual). Este archivo
> NO se importa automáticamente — se lee solo si hace falta puntualmente. El mismo
> contenido también vive completo en la rama de git `backup/diseno-cinematico-nextjs-sanity`.
